...
const NavBar = () => {
    return (
        <div className="row d-flex bg-dark height-25 w-100">
            <div className='col-3 d-flex justify-content-center align-items-center gap-5 height-25'>
                ...
                <div className="list-group list-group-flush me-4">
                    <Link to={'/characters'} className="list-group-item bg-dark text-light">Characters</Link>
            ...
            <div className='col-9 d-flex align-items-center gap-3 height-25'>
